            ...
            try
            {
                if (CbuOrigen.Substring(0, 10) == "0000000003") { 
                    ...
                    var JSONTransferencia = new TransferenciaJSON
                    {
                        ...
                        motive = motivoId, //Hay que buscar forma de comparar con nuestra BD, el id con el nombre del motivo para ponerlo aca
                    ...
                    if (response.estado == "Validada")
                    {
                        if (CbuDestino.Substring(0, 10) == "0000000003")
                        {
                            ...
                            var motivoExiste = await _bancoDBContext.TipoMotivo.FirstOrDefaultAsync(m => m.Id == motivoId); //revisacion de esto
